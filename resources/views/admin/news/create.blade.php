...
<div class="container-fluid px-4">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Add New Article</h1>
        <p class="text-gray-600">Create a new news article or blog post</p>
    </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center space-x-4">
                        <div class="flex-1">
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                Main image for the article. Recommended: 1200x630 pixels, max 2MB.
                            </p>
                ...
                <div>
                    ...
                    <input type="file" 
                           ...
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition">
                    <p class="mt-2 text-sm text-gray-500">
                        Additional images for gallery. Select multiple images. Max 2MB each.
                    </p>
                    @error('gallery.*')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
