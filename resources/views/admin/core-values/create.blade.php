...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-blue-800 mb-2">Add New Core Value</h1>
        <p class="text-gray-600">Add a new core value for your company</p>
    </div>

    <div class="bg-white rounded-xl shadow-lg p-6">
        <form action="{{ route('admin.core-values.store') }}" method="POST" enctype="multipart/form-data" id="coreValueForm">
            @csrf
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Save Core Value
                </button>
            </div>
        </form>
    </div>
...
document.getElementById('coreValueForm').addEventListener('reset', function() {
    removeImage();
});
</script>
@endsection