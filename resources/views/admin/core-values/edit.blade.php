...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-blue-800 mb-2">Edit Core Value</h1>
        <p class="text-gray-600">Update core value details</p>
    </div>

    <div class="bg-white rounded-xl shadow-lg p-6">
        <form action="{{ route('admin.core-values.update', $coreValue) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="e.g., Integration, Commitment"
                               required>
                        @error('title')
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            Use Font Awesome icon classes. Example: fas fa-handshake, fas fa-link
                        </p>
                    </div>
                        ...
                        <div class="flex items-center space-x-4">
                            @if($coreValue->image)
                                <div class="relative">
                                    ...
                                    <a href="{{ asset('images/core-values/' . $coreValue->image) }}" 
                                       target="_blank"
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="flex items-center">
                                <input type="radio" 
                                       name="is_active" 
                                       value="1" 
                                       {{ old('is_active', $coreValue->is_active) == '1' ? 'checked' : '' }}
                            ...
                            <label class="flex items-center">
                                <input type="radio" 
                                       name="is_active" 
                                       value="0" 
                                       {{ old('is_active', $coreValue->is_active) == '0' ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500">
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Update Core Value
                </button>
            </div>
        </form>
    </div>
