...
<div class="container mx-auto px-4 py-8 max-w-7xl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-blue-800 mb-2">Edit About Page</h1>
        <p class="text-gray-600">Update about us page content</p>
    </div>
  ...
  <form action="{{ route('admin.about.update', $aboutPage) }}" method="POST" enctype="multipart/form-data" id="aboutForm">
            @csrf
            @method('PUT')
            ...
            <div class="p-4 sm:p-6">
                ...
                <div id="tab-hero" class="tab-content">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="hero_description" 
                                          ...
                                          rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                          placeholder="Hero section description...">{{ old('hero_description', $aboutPage->hero_description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                <img src="{{ asset($aboutPage->hero_image) }}" 
                                     alt="Current Hero Image" 
                                     class="h-20 w-20 object-cover rounded-lg border-2 border-blue-200">
                    ...
                    <div class="mt-6">
                        ...
                        <div id="hero-stats-container" class="space-y-3">
                            <!-- Hero stats will be loaded dynamically -->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" 
                                       id="overview_title" 
                                       name="overview_title" 
                                       value="{{ old('overview_title', $aboutPage->overview_title) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="overview_description" 
                                          ...
                                          rows="4"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                          placeholder="Company overview...">{{ old('overview_description', $aboutPage->overview_description) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('overview_philosophy_title', $aboutPage->overview_philosophy_title) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="overview_philosophy_text" 
                                          ...
                                          rows="2"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                          placeholder="Philosophy text...">{{ old('overview_philosophy_text', $aboutPage->overview_philosophy_text) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('overview_philosophy_icon', $aboutPage->overview_philosophy_icon) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="mb-3">
                                    <img src="{{ asset($aboutPage->overview_image) }}" 
                                         alt="Current Overview Image" 
                                         class="h-20 w-20 object-cover rounded-lg border-2 border-blue-200">
                                    <p class="text-xs text-gray-500 mt-1">Current Image</p>
                                </div>
                                @endif
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('overview_badge_value', $aboutPage->overview_badge_value) }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                           placeholder="25+">
                                </div>
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('overview_badge_text', $aboutPage->overview_badge_text) }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="vision_description" 
                                          ...
                                          rows="4"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                          placeholder="Vision description...">{{ old('vision_description', $aboutPage->vision_description) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="vision_icon" 
                                       name="vision_icon" 
                                       value="{{ old('vision_icon', $aboutPage->vision_icon) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div>
                                ...
                                <div id="vision-points-container" class="space-y-2">
                                    <!-- Vision points will be loaded dynamically -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="mission_description" 
                                          ...
                                          rows="4"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                          placeholder="Mission description...">{{ old('mission_description', $aboutPage->mission_description) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="mission_icon" 
                                       name="mission_icon" 
                                       value="{{ old('mission_icon', $aboutPage->mission_icon) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                       placeholder="fas fa-bullseye">
                            </div>
                            ...
                            <div>
                                ...
                                <div id="mission-points-container" class="space-y-2">
                                    <!-- Mission points will be loaded dynamically -->
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="tab-scope" class="tab-content hidden">
                    ...
                    <div id="scope-sections-container" class="space-y-4">
                        <!-- Scope sections will be loaded dynamically -->
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div id="modification-services-container" class="space-y-3">
                                <!-- Modification services will be loaded dynamically -->
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div id="service-support-container" class="space-y-3">
                                <!-- Service support will be loaded dynamically -->
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="cta_description" 
                                          ...
                                          rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                          placeholder="CTA description...">{{ old('cta_description', $aboutPage->cta_description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('cta_primary_button_text', $aboutPage->cta_primary_button_text) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('cta_primary_button_link', $aboutPage->cta_primary_button_link) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                       placeholder="/contact">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('cta_secondary_button_text', $aboutPage->cta_secondary_button_text) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('cta_secondary_button_link', $aboutPage->cta_secondary_button_link) }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" 
                                      ...
                                      rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="SEO Description">{{ old('meta_description', $aboutPage->meta_description) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="meta_keywords" 
                                   name="meta_keywords" 
                                   value="{{ old('meta_keywords', $aboutPage->meta_keywords) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
...
<script>
let currentTab = 'hero';
let heroStatCount = {{ $aboutPage->hero_stats ? count($aboutPage->hero_stats) : 0 }};
let visionPointCount = {{ $aboutPage->vision_points ? count($aboutPage->vision_points) : 0 }};
let missionPointCount = {{ $aboutPage->mission_points ? count($aboutPage->mission_points) : 0 }};
let scopeSectionCount = {{ $aboutPage->scope_sections ? count($aboutPage->scope_sections) : 0 }};
let modificationServiceCount = {{ $aboutPage->modification_services ? count($aboutPage->modification_services) : 0 }};
let serviceSupportCount = {{ $aboutPage->service_support ? count($aboutPage->service_support) : 0 }};

// Load existing data
const existingHeroStats = @json($aboutPage->hero_stats ?? []);
const existingVisionPoints = @json($aboutPage->vision_points ?? []);
const existingMissionPoints = @json($aboutPage->mission_points ?? []);
const existingScopeSections = @json($aboutPage->scope_sections ?? []);
const existingModificationServices = @json($aboutPage->modification_services ?? []);
const existingServiceSupport = @json($aboutPage->service_support ?? []);
...
function addScopeSection(title = '', icon = '', color = '', points = []) {
    ...
    const pointsStr = Array.isArray(points) ? points.join(', ') : points;
...
document.addEventListener('DOMContentLoaded', function() {
    // Load hero stats
    if (existingHeroStats && existingHeroStats.length > 0) {
        existingHeroStats.forEach(stat => addHeroStat(stat.value || '', stat.label || ''));
    }
    
    // Load vision points
    if (existingVisionPoints && existingVisionPoints.length > 0) {
        existingVisionPoints.forEach(point => addVisionPoint(point));
    }
    
    // Load mission points
    if (existingMissionPoints && existingMissionPoints.length > 0) {
        existingMissionPoints.forEach(point => addMissionPoint(point));
    }
    
    // Load scope sections
    if (existingScopeSections && existingScopeSections.length > 0) {
        existingScopeSections.forEach(section => {
            const points = section.points ? (Array.isArray(section.points) ? section.points : []) : [];
            addScopeSection(section.title || '', section.icon || '', section.color || '', points);
        });
    }
    
    // Load modification services
    if (existingModificationServices && existingModificationServices.length > 0) {
        existingModificationServices.forEach(service => {
            addModificationService(service.icon || '', service.title || '', service.description || '');
        });
    }
    
    // Load service support
    if (existingServiceSupport && existingServiceSupport.length > 0) {
        existingServiceSupport.forEach(service => {
            addServiceSupport(service.icon || '', service.title || '', service.description || '');
        });
    }
});
</script>
