...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="mb-8">
        ...
        <p class="text-gray-600">Add a new solution category</p>
    </div>
        ...
        <form action="{{ route('admin.solutions.store') }}" method="POST" enctype="multipart/form-data" id="solutionForm">
            ...
            <div class="mb-8">
                ...
                <textarea id="description" 
                          ...
                          rows="3"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300"
                          placeholder="Enter solution description...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
...
document.getElementById('solutionForm').addEventListener('reset', function() {
    removeImage();
});
</script>
@endsection